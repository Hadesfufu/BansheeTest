...
static constexpr const char* BINARIES_PATH = "C:/Projects/bsf/bin/x64/Debug";
#elif BS_CONFIG == BS_CONFIG_OPTIMIZEDDEBUG
static constexpr const char* BINARIES_PATH = "C:/Projects/bsf/bin/x64/OptimizedDebug";
#elif BS_CONFIG == BS_CONFIG_RELEASE
static constexpr const char* BINARIES_PATH = "C:/Projects/bsf/bin/x64/Release";
#endif
